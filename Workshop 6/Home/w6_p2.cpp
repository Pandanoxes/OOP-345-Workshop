...
int main(int argc, char **argv)
{
	...
	std::list<const sdds::Vehicle *> vehicles;
	{
		...
		auto fastVehicles = [](const sdds::Vehicle *vehicle_) { return vehicle_->topSpeed() > 300; };
	...
	std::cout << std::endl;
	{
		...
		auto brokenVehicles = [](const sdds::Vehicle *vehicle_) { return vehicle_->condition() == "broken"; };
